...
![Tab Options](../../../Static/img//howto-reports-metrics/tabOptions.png)
...
![Select a Report](../../../Static/img//howto-reports-metrics/tabOptions.png)
...
The report result table displays the result, if any:
  ...
  ![Attestation request summary report result table](../../../Static/img//howto-reports-metrics/attestation-table-summary.png)
...
![View attestation token details](../../../Static/img//howto-reports-metrics/encodedview.png)
...
![Select a Report - Attestation requests](../../../Static/img//howto-reports-metrics/tabs-reports-attestation.png)
...
![Select a Report - All attestation services by month](../../../Static/img//howto-reports-metrics/all-services-attestation-mo.png)
...
![Attestation usage and status](../../../Static/img//howto-reports-metrics/attestation-usage-status.png)
...
![Select a Report](../../../Static/img//howto-reports-metrics/top3usage.png)
...
1. Select the **Custom report** tab.
  ...
  ![Select a Report](../../../Static/img//howto-reports-metrics/custom-rm.png)
