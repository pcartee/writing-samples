...
HD, 2K, and 4K).
3D Abbreviation for three-dimensional. No hyphen in the abbreviation. For guidelines
...
10Base-T, 100Base-T, 1000Base-T Note capitalization. See also Ethernet; Gigabit
Ethernet (1000Base-T).
...
Acronym: RAM—for random-access memory

- When to spell out: If you think your audience might not be familiar with an abbreviation
...
- Articles: Use the article a or an with an abbreviation or acronym, depending on its
pronunciation.
...
above, below You can use above or below to describe text or an object that closely
...
Preferable: Log in to the server using an administrator account.
...
Action button A customizable button on Apple Watch Ultra and some iPhone models.
Choose a function for the Action button.
action description In Automator, the description of the selected workflow action.

Action pop-up menu Don’t use. Use More button to refer to the button with an ellipsis,
or More menu to refer to the menu that the More button opens. See also More button,
More menu.
action sheet In developer materials, use to refer to a sheet that appears in response to an
action and presents a set of choices related to the current context.
In user materials, don’t use the term action sheet, sheet, or popover; instead, describe
what the user must select or do.
Correct: Tap Scan Documents.
Incorrect: Tap Scan Documents in the sheet that appears.
See also popover; share sheet; sheet.
activate, deactivate Avoid; instead, use turn on, turn off.
active Use to refer to the app or window currently being used. Preferred to in front. See
also front, frontmost; in front.
Active Noise Cancellation An AirPods listening mode. Use noise cancellation in general
references.
...
After the first reference, you can abbreviate Active Noise Cancellation as ANC in AirPods
model names.
...
Adaptive Audio An AirPods listening mode. Don’t refer to as Adaptive mode.
Correct: You can customize Adaptive Audio to allow more or less noise.
Incorrect: You can customize Adaptive mode to allow more or less
noise.
...
One Apple Park Way
Cupertino, CA 95014
- Specific Apple mailing addresses:
Department Name
Apple
...
with administrator accounts, avoid using the noun administrator by itself to describe a
person who has an administrator account in macOS. Instead, you can say a user with an
administrator account—typically, the owner (or owners) of a particular Mac computer.
Correct: To obtain a static IP address for your computer, contact your
network administrator.
Correct: You must have an administrator account to modify other user
accounts on a Mac.
...
Correct: To give a user broad privileges on a Mac, create an admin
...
Advisor, advisor Capitalize when you refer to a person in an Apple Support position,
including those at one of Apple’s third-party suppliers or providers. Don’t use agent or
representative. Use advisor if you’re not referring specifically to an Apple Support person.
Tap the button below to contact Apple Support and speak with an
Advisor.
iPhone customers can get advice from Apple Support Advisors.
See also Apple Support.
AFP Abbreviation for Apple Filing Protocol. For guidelines about spelling out abbreviations,
see abbreviations and acronyms.
afterward Not afterwards.
agent Don’t use when referring to a person in an Apple Support position. See also Advisor,
advisor.
...
Correct: You can use AirPlay to stream videos from iPhone to Apple TV 4K.
Incorrect: You can AirPlay videos from iPhone to Apple TV 4K.
...
Use numbers, not generation, to refer to models of AirPods—for example, AirPods Pro 2,
not AirPods Pro (2nd generation).
When you write about a specific model of AirPods, use the model name: Learn how to
clean your AirPods Max. You can use just AirPods if the content applies to any model: Use
AirPods to make and answer calls with your iPhone.
...
refers to products that combine functions such as printing, scanning, and copying.
...
anti (prefix) Close up except before i or a capital letter.
...
API Abbreviation for application programming interface (not application program
interface). To refer to more than one API, use APIs. For guidelines about spelling out
...
Apple The company’s official name is Apple Inc. Use Apple Inc. in copyright notices and
...
services.
Today Apple announced a new MacBook Pro.
...
Apple-certified parts, Apple-designed templates
See also addresses (mailing).

Apple Account The account that people use to access all Apple services, including the
App Store, iCloud, iMessage, and FaceTime. This account was formerly known as Apple ID.
...
People sign in to their Apple Account; they don’t sign in with their account to devices,
...
Incorrect: …on any device where you’re signed in with your Apple
Account.
If you used Apple ID to refer to the email address or phone number associated with a
person's account, replace it with email address or phone number (not Apple Account).
Correct: Enter your email address or phone number, and then enter your
password.
...
you can use wording like your Apple Account email address or phone number or the email
address or phone number associated with your Apple Account.
...
settings.
Don't use terms like iCloud account, iTunes Store account, or App Store account; people
...
to Apple authorization: Apple-authorized procedure. No hyphen in proper names: Apple
Authorized Reseller.
...
Apple Card Don’t precede with the or an. OK to use alone or in terms such as Apple Card
account.
...
family.
AppleCare Use to refer to service and support products available from Apple, including
AppleCare+, AppleCare One, AppleCare for Enterprise, and others.
Don’t use AppleCare alone to refer to AppleCare products; use the specific product
name or use AppleCare product or AppleCare products. You can also use terms such as
the following: AppleCare agreement, AppleCare coverage, AppleCare plan, AppleCare
purchase date, AppleCare service and support.
See also Apple Support.
...
Apple Creator Studio A subscription-based suite of creative apps that also includes
premium content and features. Don’t precede with the.
...
See also Apple logo.
Apple Games app An app for finding and playing games and competing with friends. In
most cases, refer to it as the Apple Games app.
Use the Apple Games app to find and download games.
You can shorten to Apple Games in contexts where people are already using the app
(Welcome to Apple Games) or in text where the word app appears nearby (Apple Games is
an app that lets you explore new games and play with friends). Don’t use just Games or the
Games app.
...
some models of iPhone, iPad, Mac, and Apple Vision Pro. Don’t abbreviate as AI.
...
Combinations of a product name and logo—known as product lockups—are carefully
designed graphics approved by Apple Marketing. For information about how to use product
lockups and the Apple logo, see The Apple Logo.
...
Apple Music You can use Apple Music to refer to the app and service that let users
...
App Store.
Apple Original Use Apple Originals or an Apple Original to refer to content that’s produced
by Apple and available from Apple TV.
With an Apple TV subscription, you can catch the latest Apple Originals.
Watch Severance, an Apple Original, from Apple TV.
See also Apple TV.
...
Incorrect: Find out where you can use Pay.
See also Apple logo.
...
iPadOS devices, and Apple TV (2nd and 3rd generation) devices.
To refer to the remote used with Apple TV 4K and Apple TV HD, use Siri Remote. (In
countries or regions where Siri isn’t available for use with Apple TV devices, use Apple TV
Remote instead.)
See also Apple TV Remote; Siri Remote.
Apple Retail Store Don’t use. See also Apple Store.
AppleScript AppleScript is used to create a script or scripts, not an AppleScript or
AppleScripts. Don’t use terms such as AppleScriptable or AppleScripting.
...
Apple Support Capitalize when referring to Apple’s service and support resources and
staff. Don’t shorten to Support.
Correct: Contact Apple Support for assistance with your new Mac.
Correct: For more information, visit the Apple Support site.
Correct: See the Apple Support article Use gestures with Apple Vision
Pro.
Incorrect: Contact Support for assistance with your new Mac.
In general references, use support.
Find out how to get technical support for your Apple products.
Extend your support coverage by purchasing AppleCare+.
See also AppleCare.
...
T2 chip.
First reference: The Apple T2 Security Chip brings a new level of
integration and security to the Mac.
Subsequent references: The T2 chip includes a secure enclave
...
Apple TV The streaming subscription service. People subscribe to Apple TV, and they can
watch content from or on Apple TV.
Watch The Morning Show on Apple TV.
Catch up on Ted Lasso from Apple TV.
OK to use as an adjective: Apple TV subscription, Apple TV content. In text, don’t write the
name Apple TV by combining the symbol with the word TV.
Correct: Get started with Apple TV.
Incorrect: Get started with TV.
See also Apple logo; Apple Original.
Apple TV 4K The current model of Apple TV hardware. Previous models include
Apple TV HD and Apple TV (2nd and 3rd generation). Don’t use Apple TV alone to refer to
the hardware device. To refer to Apple TV hardware models generically or in the plural, you
can use Apple TV device (or devices). When distinguishing between models, you can use
Apple TV model or Apple TV hardware model.
Pair AirPods with an Apple TV device.
Keep your Home Screen consistent across multiple Apple TV 4K
devices.
Not all features are available on all Apple TV models.
In general references, don’t use the with Apple TV 4K. It’s OK to use another article or a
possessive adjective. If you need to refer to a specific Apple TV 4K, it’s OK to use the.
Apple TV 4K goes to sleep after a period of inactivity.
Find the model number of your Apple TV 4K.
Make sure the HDMI cable is connected to the Apple TV 4K you’re
troubleshooting.
Don’t abbreviate Apple TV 4K as ATV 4K. In text, don’t write the name Apple TV 4K by
combining the symbol with the word TV.
Correct: Get started with your Apple TV 4K.
Incorrect: Get started with your TV 4K.
Apple TV app The app that lets you subscribe to Apple TV and find movies and TV shows.
Always include the and app to distinguish the app from Apple TV, the service.
The Apple TV app gives you access to a wide array of live and
scheduled sports events.
People can watch content in or on the Apple TV app.
You can see recommended shows and movies in the Apple TV app.
Stream Apple Originals on the Apple TV app.

Apple TV+ Don’t use. See Apple TV.
Apple TV Remote Use to refer to the Siri Remote in countries or regions where
Apple TV 4K and Apple TV HD don’t support Siri.
Use the Touch surface on the Apple TV Remote to set up your
Apple TV 4K.
See also Apple Remote; Siri Remote; Touch surface.
Apple Vision Pro Always use the full name. In general references, don’t use the with
Apple Vision Pro. It’s OK to use another article or a possessive adjective: Adjust the fit of
...
armband One word.
arrow In user materials, use pointer in general references. Use arrow or arrow pointer
...
looks like a spinning gear. In user materials, use progress indicator and describe what it
looks like.
Developer materials: Don’t use the asynchronous progress indicator for
processes that start out indeterminate but could become determinate.
User materials: A progress indicator (looks like a spinning gear)
appears.
See also indeterminate progress bar.
at sign (@) Use at, not @, except in email addresses and social media user names. When
referring to the symbol itself, use at sign and include the symbol in parentheses on first
mention: an at sign (@).
...
Audio Units Always plural; not Audio Unit. In user materials, use only as an adjective (the
Audio Units format).
...
Safari settings.
Auto Focus An iOS camera feature. Use autofocus to refer to automatic focusing in
general.
AutoMix The feature in Apple Music that manages transitions between songs.
Use AutoMix to seamlessly transition from one song to the next.
autoplay (n., v.), AutoPlay Use lowercase when referring generically to a feature that
plays content automatically.
Find out how to turn off autoplay for videos in Safari.
You can allow videos to autoplay on specific websites.
Use AutoPlay when referring to the feature in Apple Music.
When you play a song, AutoPlay adds similar songs to your queue.
...
access point, wireless access point, or wireless router. Capitalize in product names:
AirPort Express Base Station, AirPort Extreme Base Station. See also AirPort.
...
bit (n., adj.) Short for binary digit, the smallest unit of computer data. A bit has a single
binary value, either 0 or 1. Don’t use when you mean pixel or dot. Hyphenate when used as
...
Correct: Treat the container as opaque.
...
such as deny list/allow list, deny list/permit list, unapproved list/approved list, or reject list/
accept list.
Correct: To allow incoming email from an address, add the address to
your server’s allow list.
Incorrect: To allow incoming email from an address, add the address to
...
Correct: If your computer didn’t come with an internal Bluetooth
module, you can have one installed by an Apple Authorized Service
Provider.
Correct: Your computer can connect to and transfer information to
...
breathing disturbances Capitalize only when referring to an onscreen label. Otherwise,
use lowercase.
To view your breathing disturbances data, tap Breathing Disturbances.
...
build-to-order Not built-to-order. Always use as an adjective (your build-to-order
computer). Don’t abbreviate as BTO.
built-in (adj.), built in (pred. adj.), built into (pred. adj.) In headings that use title-style
capitalization, don’t capitalize in (exception to the rule of capitalizing the second word of a
hyphenated compound).
...
computer. It’s preferable to use a term such as included or comes with. Don’t use
prebundled.
...
button Buttons initiate an action when clicked, tapped, or pressed. You click or tap an
onscreen button.
...
- Capitalization and punctuation: Use sentence-style capitalization. Use a period for a
...
Correct: You can connect a camcorder to your computer to import your
video footage.
Incorrect: You can connect a video camera to your computer to import
your video footage.
...
can, might, may Use can to express the capacity to do something; use might or may to
suggest the possibility of doing something; use may to express permission.
...
words, such as être.
CarPlay People connect devices to CarPlay, do tasks with or using CarPlay, and open apps
or change settings in CarPlay.
Connect your iPhone to CarPlay.
You can play music and make phone calls with CarPlay.
Get directions using CarPlay.
Open Maps in CarPlay and select a route.
You can change the map view in CarPlay.

CarPlay Dashboard is preceded by the; CarPlay Home is not.
Use the playback controls on the CarPlay Dashboard.
CarPlay Home shows all your CarPlay apps organized into pages.
Don’t use CarPlay as a verb.
...
chapter Don’t capitalize the word chapter, except in cross-references to actual titles
(exception to The Chicago Manual of Style).
...
Select Encrypted Messages.
Select the Encrypted Messages checkbox.
Select the checkbox labeled Encrypted Messages.
...
a hotel room using the Wallet app), hyphenate check-in as a noun and adjective; don’t
...
a Family Sharing group. Don’t use child Apple Account.
...
chip A processor or other integrated circuit: A16 Bionic chip, A18 Pro chip, M4 Max chip.
It’s OK to use the name of the chip alone, without chip: A16 Bionic, A18 Pro, M4 Max, and
so on.
See also M-series chips; processor.
...
Use cleanup (n., adj.) and clean up (v.) in general references.
...
See also SDH.
cloud Avoid using the cloud to refer to iCloud. However, you can say content is in the
cloud if the context makes clear you’re referring to iCloud.
...
layout, click Yes.
See also Intro to technical notation.
...
you can say a person who is color blind, a person who has color blindness, people with
color blindness.
...
trackpad) actions with keyboard presses—for example, Option-Shift-click. In user
materials, use keyboard shortcuts to refer to actions that include keyboard presses.
...
a pop-up menu.
A command is in a menu, not on a menu; a menu contains commands. Users choose
commands; they don’t select commands.
...
edge connector: the connector on the edge of a peripheral card; fits
into a slot
minicircular connector: an 8-pin connector [Don’t use mini-DIN.]
...
contacts, Contacts Use lowercase to refer to a user’s collection of contacts: Add a
contact, update your contacts. Capitalize when referring to the app name: Use Contacts to
call someone, get help using Contacts. See also iCloud.
...
- Avoid contractions of multipart verbs (could’ve), colloquialisms (workin’), and
other contractions that are uncommon or awkward-sounding in written materials
(everybody’d, how’re, it’ll, many’s, when’s, where’ll, who’ve, why’s). Possible exceptions
include text that’s meant to be spoken (such as a script) and direct quotes in running
text.
...
CPU Abbreviation for central processing unit. In most cases, don’t spell out. OK to use
in developer documentation, technical specifications, and descriptions of processor
architecture.
You can analyze CPU usage with the Processor Trace instrument.
M4 Pro features a powerful CPU with up to 14 cores.
Mac mini has an M4 chip with 10-core CPU and 10-core GPU.
In user materials, use CPU only to refer specifically to CPU activity. Use chip when
referring generally to the processor in a device.
To view CPU activity, use the Activity Monitor app.
The chip in Mac Studio delivers unprecedented power for demanding
tasks.
See also chip; processor.
...
Guide.
The iMac Getting Started Guide provides all the information you need to
set up and start using your new iMac.
- Titles of chapters or sections of a document: Authoring and output tools typically
...
enclose the word Chapter or the chapter number in quotation marks.
...
dark appearance.
dashboard Use lowercase in general references; capitalize in the names of features.
Check your health and fitness data in one dashboard.
Use the audio controls on the CarPlay Dashboard.
...
continuous range.
bits 3–17, 2003–2005
- Compound adjectives: Use an en dash between the elements of a compound adjective
when one of those elements is itself two words.
desktop interface–specific instructions
Grammy Award–winning producer
ex–Sun Studio tour guide
- Minus sign: Use an en dash as a minus sign (except in code font, where you use a
hyphen).
–1, –65,535
...
Not collective and thus plural: Selected data are transferred
immediately.
...
Incorrect: The conference was held on the 12th.
...
deafblind, Deafblind Use deafblind to refer generally to people who have a combination of
...
Capitalize Deafblind when referring to people who identify culturally as Deafblind
(sometimes spelled DeafBlind).
...
Capitalize Deaf when referring to people who identify culturally as Deaf.
...
resources such as servers and websites. You can also use similar terms, such as deny
list/permit list, unapproved list/approved list, or reject list/accept list. Don’t use blacklist/
whitelist.
...
Don’t hyphenate the adjective form: deny list data is stored at the partition level; export
the allow list file. Don’t use deny list and allow list as verbs; instead, use deny, allow, and
so on (you can deny IP addresses to prevent them from accessing the server). Don’t use
deny listed and allow listed; instead, use denied, allowed, and so on.
...
User materials: A progress indicator (a moving bar) shows the status of
the download.
...
plural)
Correct: If you have multiple iPad devices, you can…
Incorrect: If you have multiple iPads, you can…
...
Mac or Apple Watch) in most cases. In service documentation, if a device name is repeated
frequently and it’s clear from the context what the device is, it’s OK to shorten to device, or
to another acceptable short form—for example, computer instead of Mac, or watch instead
of Apple Watch.
...
Incorrect: The Mac user interface is different than that of a
Windows PC.
Incorrect: The Mac user interface is different from a Windows PC.
differently than Use when comparing two parallel clauses. Don’t use different than,
different from, or differently from for this purpose. But rewrite whenever possible to set up
a construction in which different from is used to compare two parallel nouns.
...
DIMM Acronym for dual inline memory module. For guidelines about spelling out
acronyms, see abbreviations and acronyms.
...
disclosure arrow A button that reveals or hides options when clicked (not the disclosure
button). It’s usually not necessary to mention that it’s closed (pointing to the right) or open
(pointing down).
...
desktop; don’t use disk title for this purpose.
...
Dock A bar of icons (for example, at the bottom of the screen on iPhone) that provide
quick access to apps and other items.
...
Incorrect: Time Machine backs up all your documents to an external
disk.
See also file.
...
Dolby Vision
When referring to an audio format, include the descriptive term surround sound on first
reference.
...
double-byte characters Not 2-byte characters.
...
double-layer disc; DVD + R DL (Double Layer). Use lowercase for general references.
...
Don’t use to refer to quickly pressing a mechanical button twice; use double-click.
To view your open apps, double-click the Home button.
...
Avoid: iCloud downloads your new photos to all your devices.
Preferable: iCloud keeps your photos up to date on all your devices.
See also iCloud.
...
shown.
dpi Abbreviation for dots per inch (n.) and dot-per-inch (adj.). For guidelines about
spelling out abbreviations, see abbreviations and acronyms.
...
Correct: Drag the Volume slider to change the volume.
Correct: Choose Tools > Annotate > Rectangle, and then drag to create
a rectangle.
Incorrect: Drag the mouse to draw a rectangle.
Don’t use click and drag. Don’t use place, put, or move when you mean drag.
Correct: Drag your songs into the order you want.
Correct: Drag the icon to the Trash.
Incorrect: Click and drag the icon to the Trash.
...
Don’t use tap and drag.
Correct: Drag to see a different part of the map.
Incorrect: Tap and drag to see a different part of the map.
Don’t say drag your finger.
Correct: Drag across the text.
Incorrect: Drag your finger across the text.
See also gestures; swipe (n., v.).
- On Apple Vision Pro: Drag refers to the act of pinching and holding your thumb and
finger together to select an object, and then moving your hand to drag the object. In
instructions for users, in most cases use pinch and drag (not just drag).
...
Correct: Drag the file to the printer icon.
Incorrect: Drag and drop the file onto the printer icon.
drag handle Don’t use; use handle. See also handle.
DRAM Acronym for dynamic random-access memory. Pronounced “DEE-ram.” For
...
drop zone Two words.
dual Hyphenate compound adjectives beginning with dual.
...
have two displays or dual displays, not a dual display. See also extended desktop (n., adj.);
...
dual-processor (adj.) Computers with two processors are dual-processor computers.
They have dual processors, dual Intel Xeon processors, and so on. Don’t use a dual
processor or DP. See also dual-core (adj.).
duckhead Don’t use. When describing the wall-plug module that attaches to an Apple
power adapter, use AC wall adapter.

due to Avoid; instead, use alternatives such as caused by or because of.
Avoid: The interference was due to a faulty cable.
Preferable: Your apps will open more quickly because of the additional
memory.
dummy Don’t use. To refer to placeholder content, use placeholder, sample, test, stub, or
another alternative.
Correct: Use layout guides to replace the placeholder views you
created.
Incorrect: Use layout guides to replace the dummy views you created.
DV An industry-standard video format. Generally, use DV to refer to the format or to
products that use the format. Don’t use DV to refer to the medium digital video. Related
terms include DV format, DV standard, DV camera, DV camcorder.
DVD An optical disc designed for high-capacity storage. Use disc, not disk, to refer to
DVD media.
DVD drive Avoid; use optical drive. See also SuperDrive.
...
edit menu, Edit menu A menu that lets you perform actions (such as copy, paste, and
select) on objects or text.
Capitalize Edit when referring to the Edit menu in the menu bar: the Select All command in
the Edit menu. Avoid using edit menu (lowercase) in user materials; simply describe what
people should choose from the menu.
Correct: Tap Copy.
Incorrect: Tap Copy in the edit menu.
OK to use edit menu in developer materials. See also menu bar; menus.
...
Don’t use abbreviations such as ed, edu, or HED.
...
username@domain
For example, the address steve@icloud.com specifies a user named “steve” at the icloud.
com domain.
- In text: Use plain text for email addresses in text.
- Line breaks: Avoid line breaks in an email address. If necessary, set the address on a
separate line.
- Punctuation: If an email address ends a sentence, it’s OK to use a period.
See also internet addresses.
...
Correct: Make sure the Use Touch ID checkbox is selected in Notes
settings.
Incorrect: Make sure the Use Touch ID option is enabled in Notes
settings.
...
app.
Use lowercase environment when referring to custom environments in third-party apps.
...
Correct: You can import an EPUB file into a template.
Incorrect: You can import an EPUB into a template.
See also file types.
...
Esc key Include the word Escape in parentheses on first occurrence.
...
Ethernet A cable-based system for connecting computers and peripheral devices. OK
to use Ethernet network or simply Ethernet, depending on the context. See also Gigabit
Ethernet (1000Base-T).
EU No periods. OK to abbreviate or to spell out European Union as a noun. Use the
...
additional display. You can also use external monitor. See also display (n.); monitor.
...
family controls Don’t use; use parental controls.
...
- Capitalization: Use sentence-style capitalization for figure titles. Don’t end a title with
punctuation, even if the figure title is a complete sentence. Use articles in captions
whenever appropriate.
Correct: The Apple menu
Correct: AirPort Express connected to a printer
Incorrect: AirPort Express Connected to a Printer
...
It’s also customary to use format when referring to encoding methods.
...
to use code font.
User materials: Name the file Paperdoc.
Developer materials: The folder contains the CurrencyConverter.
nib file.
...
Correct: The image is saved as a JPEG file.
Incorrect: The image is saved as a .jpeg file.
...
kind of file, such as a JPEG file or a PDF file. Don’t use file format (a file’s structure and
method of storing data) when you mean file type.
...
or the product.
Fit Dial The dial that lets you adjust the fit of Apple Vision Pro. You turn the Fit Dial; you
don’t rotate it.
...
users turn it off.
Correct: Turn a Focus on or off in Control Center.
Correct: Use the Work Focus to work without distractions.
Incorrect: Activate a Focus in Control Center.
When a Focus is on, use on or active to describe it (don’t use turned on).
Correct: When a Focus is active…
Incorrect: When a Focus is turned on…
...
hierarchical structure known as a file system. In developer materials, folders are usually
...
Burn Folder [The word Folder appears in the folder name on the screen.]
Applications folder [The word folder doesn’t appear on the screen.]
...
Acceptable: If an app doesn’t respond, you can force quit it.
Preferable: If an app doesn’t respond, you can force it to quit.
Force Touch A technology used in trackpads that senses how hard the user presses. A
trackpad that uses Force Touch technology is called a Force Touch trackpad. Don’t use
Force Touch as a verb; use force click or press harder. See also force click (v.); press.
...
form factor Avoid; use design, enclosure, or another term.
...
forward compatibility Not future compatibility or upward compatibility.
...
free Don’t use to refer to available memory or storage space; use available.
...
Correct: If the pointer freezes, or if the computer stops responding to
the mouse, trackpad, or keyboard, follow these instructions.
Incorrect: If the computer freezes, follow these instructions.
Incorrect: If you experience a freeze, follow these instructions.
...
full Use a hyphen in compound adjectives beginning with full.
...
- Future events: Future tense is sometimes appropriate—for example, when a product
...
- Adjective: Don’t hyphenate the adjective form.
a 1 GB SO-DIMM
a 320 GB hard drive

Gbit (n., adj.) Abbreviation for gigabit. For guidelines about spelling out abbreviations, see
abbreviations and acronyms.
- Noun: In the noun form, use a space between the numeral and the abbreviation. Use the
preposition of before the unit that the value quantifies.
10 Gbit of memory
...
generation: sixth-generation iPad mini, second-generation chip, previous-generation Mac
Studio. When the generation follows the name, use the numeral: iPad (5th generation).
Don’t shorten generation to gen or G—for example, 10th-gen iPad or iPad 9G.
...
Apple Vision Pro. Don’t refer to them as finger gestures; use simply gestures.
When you write instructions that include gestures, in general, don’t include the word
finger.
Correct: Swipe left or right.
Incorrect: Swipe your finger left or right.
...
Defining reference: Pinch two fingers together or apart to zoom out or
in.
Other occurrences: Pinch to zoom in on the page.
...
GHz (n., adj.) Abbreviation for gigahertz. For guidelines about spelling out abbreviations,
see abbreviations and acronyms.
- Noun: Use a space between the numeral and the abbreviation.
at a rate of 3.0 GHz
- Adjective: Don’t hyphenate.
a 3.0 GHz processor
...
Gigabit Ethernet (1000Base-T) A standard that allows data transmission rates of up to 1
gigabit per second (1000 megabits per second). See also Ethernet; Fiber Gigabit Ethernet.
...
term in an app’s UI. Otherwise, use character.
...
GPU Abbreviation for graphics processing unit. In most cases, don’t spell out. OK to
use in developer documentation, technical specifications, and descriptions of processor
architecture.
Metal sends the commands to the GPU to be executed.
The GPU represents a substantial leap forward in graphics architecture.
M5 Max pairs the 18-core CPU with an up-to-40-core GPU.
In user materials, use GPU only to refer specifically to GPU activity.
Check the GPU activity in the Activity Monitor app.
Use terms like graphics or graphics processor when referring generally to graphics
capabilities.
Correct: If your Mac runs more slowly when you do graphics-intensive
tasks…
Incorrect: If your Mac runs more slowly when you do GPU-intensive
tasks…
grab point One of a set of movable points around a text selection.
See also handle.
grandfathered, grandfathered in Don’t use; use an alternative that’s appropriate to the
context, such as legacy, exempt, or preexisting. Or reword the sentence using you can
keep, allowed to remain, or similar wording.
Correct: You can keep your plan if you purchased it before January 1,
2021.
Incorrect: Your plan is grandfathered in if you purchased it before
January 1, 2021.
...
Use graphics to refer to software or hardware used to process graphics.
...
graphics card Don’t use when referring to Apple products with Apple silicon, which
have an integrated GPU built into the chip. Instead, use GPU or graphics processor. See
also GPU.
Graphics Interchange Format See GIF.
graphics processing unit See GPU.
gray Not grey.
grayed Don’t use; use dimmed.
...
grille Note spelling: grille pitch, speaker grille.
grounded outlet Not three-prong outlet.
...
Don’t use drag handle. In apps that have more than one type of handle, you may need
to describe or name handles (for example, white handle, outer handle, corner handle,
selection handle, fade handle, trim handle).
...
Incorrect: A drag handle appears on the motion path.
See also grab point.
...
Correct: If the computer doesn’t respond to input from the mouse,
...
Preferable: You feel a tap when your message is sent.
Avoid: You receive a haptic alert when your message is sent.
...
See also SDR (n., adj.).
head band Two words (exception to Merriam-Webster). Lowercase when referring
generically to the bands that secure Apple Vision Pro to your head. Capitalize the names of
specific bands: Solo Knit Band, Dual Knit Band, Dual Loop Band.
...
following:
- Hearing Aid: Use the name with feature.
You need AirPods Pro 2 to use the Hearing Aid feature.
- Hearing Protection: You can use the name with or without feature.
...
- Hearing Test: You can use the name with or without feature. OK to shorten to just test if
...
book.
Help button A button that opens help content for an app. The standard Help button has a
...
high Use a hyphen in compound adjectives beginning with high.
...
highlight (v.) Don’t use when you mean select.
...
in the window below.
Incorrect: As you type in the search field, matching icons highlight in
the window below.
See also highlighted (adj.); highlighting (n.); select (v.).
highlighted (adj.) Not hilighted. Don’t use inverted except in developer materials. When
explaining highlighting, use a highlighted icon changes color or a highlighted icon is
filled in.
...
Correct: Search results appear below.
Incorrect: Search hits appear below.
Acceptable: This website gets many hits per day.
Preferable: This website gets many visits per day.
...
In developer materials, use home directory.
See also directory; folder; pathnames.
homepage Use to refer to a webpage that serves as the directory or entry point to a
website. Don’t use landing page or portal. Don’t use homepage to refer to an entire website.
Correct: The Apple homepage has links to product information,
including purchasing options.
Correct: Visit the Apple website for more information about Apple products.
Incorrect: You can purchase products on the Apple homepage.
...
up as a stereo pair.
Home Screen The main screen on iPhone, iPad, or Apple TV 4K, and one of the two main
...
The Home Screen on Apple TV 4K provides easy access to apps and
settings.
...
hover (v.) Avoid using hover over to describe the act of holding the pointer over an
onscreen element until something occurs. Use hold the pointer over or move the pointer to
instead.
...
Don’t use hover the pointer over.
...
You can find the file at this address: http://www.books.com/classics.
html.
...
See also Intro to inclusive writing.

hypertext link Don’t use; use link. See also link (n.).
...
- Confusion might result if the hyphen were omitted, as in parameter-list pointer or
random-access memory.
- The second word is a past or present participle, as in binary-coded decimal or color-
matching algorithm.
...
- Location compounds: Hyphenate compounds such as lower-left corner, top-right
portion.
...
iCloud Capitalize the C in iCloud in all references to iCloud or the iCloud website (iCloud.
com). Don’t capitalize the C in email addresses or when giving the URL for a particular
domain of the iCloud website (icloud.com/calendar).
...
wherever you go.
- Signing in: To access iCloud features, users sign in to their Apple Account. Don’t use
sign in to iCloud.
Correct: Your music library is available on all your devices where you’re
signed in to the same Apple Account.
Incorrect: Your music library is available on all your devices where
you’re signed in to iCloud.
Exception: Users sign in to or sign out of the iCloud.com website.
Don’t use the term iCloud account.
...
Don’t say that iCloud syncs devices with each other; instead, describe content as being
available from every device, updated automatically across all your devices, and similar
alternatives.
...
IEEE Abbreviation for Institute of Electrical and Electronics Engineers. For guidelines about
spelling out abbreviations, see abbreviations and acronyms.
...
within other apps. You can refer to the in-app feature as an experience.
...
Image Wand An Apple Intelligence feature. Don’t precede with the.
...
content.
IMAP Acronym for Internet Message Access Protocol. For guidelines about spelling out
acronyms, see abbreviations and acronyms.
...
Correct: You can send messages using iMessage.
Correct: You can turn on iMessage in Messages settings.
Incorrect: If you get an iMessage that looks like spam, you can report it
to Apple.
See also message.
iMovie Don’t use iMovie when you mean movie or project.
Correct: You can share your movie on YouTube.
Incorrect: You can share your iMovie on YouTube.
See also movie.
impairment In general, use disability instead of impairment, or refer to the specific
disability (blind or low vision, deaf or hard of hearing).
...
inclusive language See Intro to inclusive writing.
...
Developer materials: Use an indeterminate progress bar when the
duration of a process can’t be determined.
User materials: A progress indicator (a spinning striped cylinder) lets
...
industry standard (n.), industry-standard (adj.) Note hyphenation of adjective: the
industry standard, an industry-standard video format.
...
of your document.
- Capitalization: Capitalize Inspector when it’s a button name or in a menu command.
Click the Inspector button in the toolbar.
Choose Tools > Inspector.
Otherwise, spell with a lowercase i.
Correct: You can add a hyperlink using the inspector.
Incorrect: You can add a hyperlink using the Inspector.
...
Correct: Click Download to start the installation process.
Incorrect: Click Download to start the install process.
...
preferable to:
- Break after a colon (:), a double slash (//), or a slash (/)
www.apple.com/legal/
rfexposure
- Break before any other punctuation mark or symbol
www.energystar
.gov
...
intranet A private network, usually owned by a corporation or an institution (your
company’s intranet). See also internet, Internet.
...
You can install iOS 26 on iPhone 11 or later.
- In any context where it’s friendlier—or clearer—to use the device names
Acceptable: Learn how to back up your iOS or iPadOS device.
Preferable: Learn how to back up your iPhone or iPad.
...
product.)
Don’t use iOS device to refer to devices that use iPadOS.
...
- Chip or generation: iPad models can be identified by the chip (for more recent models)
...
iPad Air (5th generation) features a Liquid Retina display and the Apple
M1 chip.
...
iPad (8th, 9th, and 10th generation) and iPad (A16)
iPad mini (5th and 6th generation) and iPad mini (A17 Pro)
- Display size: You can include the display size before or after the name: 12.9-inch iPad
Pro, iPad Pro (12.9-inch). To include both the display size and the chip (or generation)
...
- Capacity: The capacity can be listed before or after the name: 512 GB iPad Pro, iPad Pro
512 GB.
...
iPadOS 26 bring a powerful new windowing system.
Some apps have versions that work on multiple platforms. To distinguish between versions
of an app, use [app name] for [platform].
Learn about the new features of Pages for iOS and iPadOS.
You can add tracks to a song in GarageBand for Mac.
...
device.
You can stream movies from iPadOS devices to Apple TV 4K.
...
iPhone In general references, don’t use the with iPhone. It’s OK to use another article or a
possessive adjective. If you need to refer to a specific iPhone, it's OK to use the.
...
Acceptable (in case of tools limitations): iPhone XR, iPhone XS,
iPhone XS Max
...
IPsec Abbreviation for Internet Protocol Security.
ISP Abbreviation for internet service provider; not ISP provider. For guidelines about
spelling out abbreviations, see abbreviations and acronyms.
...
- References to document titles: Italicize the entire title.
See the iPhone User Guide.
- Letters as letters, words as words, and phrases as phrases: Italicize.
the i, the o’s
the word restart
the phrase Welcome to iOS 26
...
at the outlet.
- Placeholder names: Italicize.
Choose File > Add Files to [app name].
...
Replace volumeName with a name of up to 12 characters.
See also placeholder names; titles of works; variables.
it’s, its Don’t confuse it’s (the contraction for it is) with its (a possessive pronoun): It’s
important for the department to keep track of its computers. See also contractions;
possessives.
...
keyboard equivalent Don’t use; use keyboard shortcut.
...
key, keys You press a key on a keyboard or tap a key on a touchscreen; you type a
...
First occurrence: Press the Control key.
...
- Punctuation keys and nonalphanumeric keys: When a punctuation key or
nonalphanumeric key is used in a combination keystroke, or as a modifier for the word
key, capitalize the key name. (However, use lowercase for punctuation marks and
...
Shift-Command-Tilde (~)
- Keyboard shortcuts using combination keystrokes: In combination keystrokes, use
...
- Keys labeled with two characters: When a key with two characters is used in a keyboard
...
Correct: For more information, press Shift-Command-Question Mark.
Incorrect: For more information, press Shift-Command-Slash.
...
Correct: To increase the Loupe diameter, press Option-Shift-Plus Sign.
Incorrect: To increase the Loupe diameter, press Option-Plus Sign.
...
keypad Use keypad or numeric keypad, not numeric keyboard.
keypress One word.
keystroke One word.

key-up (adj.) Note hyphenation.
keyword Refers to a special word that identifies a particular type of statement or
command, such as int or while. Follow the capitalization style of the programming language
involved.
...
kHz (n., adj.) Abbreviation for kilohertz. For guidelines about spelling out abbreviations,
see abbreviations and acronyms.
...
materials.
Launchpad Don’t use in content about macOS 26 or later. To refer to the Dock icon used
to open apps, use Apps icon. To refer to the location where you browse and open apps, use
Spotlight. See also Spotlight.
...
Don’t call it the left arrow button or the left-pointing arrow.
Click the left arrow to view more episodes.
Don’t use when you mean Back button.
...
Family Sharing lets you share Apple purchases and subscriptions with family.
...
library Use lowercase in general references: your music library, the photo library.
Capitalize the names of interface elements: click Library.
...
Correct: When creating a webpage, be sure to link to other interesting
webpages.
Incorrect: Click the map to link to other pages on the site.

liquid contact indicator See LCI.
Liquid Glass An interface design featuring a glasslike visual effect that provides a
consistent experience across Apple devices. Don’t precede with the.
Liquid Glass brings a new look to iPhone.
...
In instances where a Live Photo might not play, avoid describing the Live Photo as playable
or not playable; instead, use alternatives such as you see only the still image.
...
Incorrect: You can copy and share Live Text in a photo.
local area network See LAN.
localizable Don’t use.
Correct: An app that follows the human interface guidelines should be
easy to localize.
Incorrect: An app that follows the human interface guidelines should be
easily localizable.
...
start from scratch
piggy-backing
- Examples and graphics: Avoid examples and graphics that show events or activities
...
See also Intro to international style; Intro to inclusive writing.
localize (v.) Takes the preposition for, not to.
Correct: Whether you localize your app for the French language or for
French Canada, make sure you test its interface.
Incorrect: Whether you localize your app to the French language or to
French Canada, make sure you test its interface.
Location Services The feature name. Singular.
Correct: Make sure Location Services is turned on.
Incorrect: Make sure Location Services are turned on.
...
Users log in to a file server (not log on to); users log out of a file server (not log off, log off
of, or log out from).
...
together.
Subsequent references: Tap an app to open it.
...
- Generic references: Don’t refer to a Mac computer as a machine, CPU, or PC;
acceptable alternatives are computer or personal computer.
...
Macao Use this spelling, not Macau.
Mac App Store Apps for the Mac are available in, on, or from the Mac App Store. Precede
the name with an article in text. Don’t abbreviate as MAS.
Find the item you want on the Mac App Store.
To download an app from the Mac App Store, open the App Store app
on your computer.
...
Don’t use Mac OS to refer generically to the operating system.
Correct: To determine which version of the Mac operating system you
have…
Incorrect: To determine which version of the Mac OS you have…

Features are in macOS, not on macOS.
Correct: In macOS, you can…
Incorrect: On macOS, you can…
...
Correct: You can give users access to the server.
Incorrect: Create a password to make your macOS Server more secure.
When discussing administrative tasks users can do in the Server app, use the Server app.
...
male Don’t use to describe a type of connector. Use plug or connector; if you use
connector, describe the connector by its shape, icon, or other identifying feature.
Correct: Insert the plug into the socket to ensure a reliable connection.
Incorrect: Insert the male endpoint into the female endpoint to ensure a
reliable connection.
See also connector; female; mate.
man Don’t use man (or compound words that include man) to refer to people in general.
staff, workforce (not manpower)
work hours, people hours (not man hours)
artistry, craft (not craftsmanship)
unstaffed (not unmanned)
...
Managed Apple ID.
Correct: Some features and settings aren’t available to Managed Apple
Accounts.
Incorrect: Some features and settings aren’t available to accounts with
Managed Apple IDs.
See also Apple Account.
Managed Apple ID Don’t use; use Managed Apple Account. See also Managed Apple
Account.
...
- Electronic delivery: If a manual is delivered electronically (for example, as a PDF file
available from www.apple.com/support), don’t call the manual an electronic manual;
simply describe it for the user.
The manual is available as a PDF file at www.apple.com/support.
- Cross-references: To refer to documentation that may be either printed or electronic,
use documentation.
...
- The default branch of a source repository. Instead, use main branch.
...
master branch Don’t use to refer to the default branch of a source repository; use main
branch.
master-detail (adj.) Don’t use; use list-detail or navigation-detail.
...
Correct: Anything written on the primary device is given to the
secondary device as input.
Incorrect: Anything written on the master device is given to the slave
device as input.
Correct: In a multipeer session, there is no explicit separation of devices
into host and client roles.
Incorrect: In a multipeer session, there is no explicit separation of
...
mate Don’t use to refer to connecting hardware. Use connect.
Correct: Securely connect the cable connectors.
Incorrect: Securely mate the cable connectors.
See also connect.
...
active.
Correct: To maximize a window, Option-click the green button.
Incorrect: To maximize a window, click its icon in the Dock.
Correct: To make a minimized window active, click its icon in the Dock.
See also minimize (v.), minimized (adj.).
maximize button The rightmost (green) button of the three window controls at the left
of the title bar. Users click this button to go full screen, or Option-click it to maximize the
window.
See also maximize.
...
abbreviations, see abbreviations and acronyms.
measurement See Intro to units of measure.
...
When you discuss video, audio, and still-image content, however, you can use media as a
...
by processors. Memory can refer to random-access memory (RAM), virtual memory, swap
files, and portable storage devices (such as flash drives), among others.
...
active app (File menu, Edit menu, and so on) and menus for system status icons (icons on
the right, also called menu bar icons, menu bar status icons, or menu bar items). If you
need to refer to the menu type, use pull-down menu, not pop-up menu.
Menu button A physical button on the Siri Remote (called the Apple TV Remote in
countries or regions where Siri isn’t available for use with Apple TV devices) and the Apple
Remote. See also Apple Remote; Apple TV Remote; Siri Remote.
...
- Shortcut menus: A shortcut menu is a menu that appears when a user presses the
...
message (audio message, email message, MMS message, SMS message, text message,
video message).
Send a message to your friend.
The Messages app automatically chooses the type of group message to send.
Avoid using message as a verb. Instead, use send a message to.
Correct: Send a message to your family.
Incorrect: Message your family.
See also chat (n., v., adj.); text message.

message list The list of messages in the viewer window in Mail.
metadata One word.
MFi Short for Made for iPhone, iPod, and iPad. A licensing program for manufacturers of
accessories that work with Apple devices.
Learn how to pair your MFi hearing device with your iPad.
MHz (n., adj.) Abbreviation for megahertz. In both the noun and adjective form, use a
...
If mode is part of a feature name, capitalize or use lowercase depending on the feature.
...
More button, More menu Use More button to refer to a button labeled with an ellipsis
(either with a circle or without a circle ). Use More menu to refer to the menu of
options that the More button opens.
To show completed reminders, tap the More button , and then choose
Show Completed.
The standard toolbar in the Notes app includes a More menu with
additional actions.

In some apps, a button with an ellipsis might have a more specific name based on its
function—for example, the View Options button in the Mail app on Mac. In those cases, use
the app-specific name.
See also Character Viewer.
...
used.
Preferable: Use the Recent Items command to connect to servers you’ve
recently used.
...
Don’t use mount as an intransitive verb.
Correct: Mount the volume.
Incorrect: The volume mounts.
...
screen, such as clicking, dragging, selecting, or choosing. See also choose; click; drag;
press; select (v.).
...
to each set of M-series chips as a family: the M4 family of chips, the M5 family. M-series
chips include M1, M2, M3, M4, and M5. Chip names can include Pro, Max, and Ultra: M4
Pro, M3 Ultra, M5 Max.
MacBook Pro with the M5 Pro chip handles demanding workflows and
AI-based tasks with ease.
The M5 Max chip is designed for the most extreme workflows.
It’s OK to use the name of the chip alone, without chip.
Like M4 Pro, M4 Max supports Thunderbolt 5 at transfer speeds of up
to 120 Gbit/s.
M5 Max brings next-generation speed and powerful on-device AI to
your work.

To refer to devices with an M-series chip, you can use terms such as Mac with the M5 chip
and iPad Pro with M4; don’t use M5 Mac, M4 iPad, or other variations. Don’t refer to an
...
multi (prefix) Close up except before i.
...
multiprocessing, multiprocessor A multiprocessor computer has multiple processors, not
multiprocessors.
...
Neural Engine Technology in A-series and M-series chips that accelerates AI and machine
learning tasks.
neurodivergence (n.), neurodivergent (adj.) Use neurodivergence to refer to a
neurological difference (such as dyslexia). Use neurodivergent to refer to an individual who
...
Correct: Math Notes, introduced with iOS 18…
Incorrect: The new Math Notes feature…
News See Apple News.
...
nonsexist language See Intro to inclusive writing.
...
Notification Center Don’t precede with the.
To open Notification Center, click the date and time in the menu bar.
number If space is limited, abbreviate as no. See also number sign.
...
Correct: Two hundred fifty functions are available in the Function
Browser.
...
We have 25 computers and 4 printers on the network. [Computers and
printers are the same category.]
...
Correct: 2013–2019
Incorrect: 2013–19
- Commas: Use a comma to set off numbers of five digits or more. (If your editor has
...
refers to components attached to a circuit board or logic board. Use built in or internal
unless you need to make clear that a component is attached to a board.
...
In informal contexts, it’s OK to describe people as being online, but in most cases use a
more specific term (for example, signed in or connected to the internet).
...
See also offline.
on/off switch Not on/off button.
onscreen (adj., adv.) One word.
onsite One word.

onto, on to Use on to when on is part of the verb.
...
the action. If it’s important to emphasize that the action is optional, you can say If you
want to…
Correct: If you want to set a disk quota, enter the number and specify
megabytes (MB) or gigabytes (GB).
Incorrect: Optionally, enter a disk quota and specify megabytes (MB) or
gigabytes (GB).
Correct: To set a trust level, enter the command in Terminal.
Incorrect: Optionally, set the trust level by entering the command in
Terminal.
...
See also tab.
panel Don’t use in user materials; use dialog, window, or pane.
...
parental controls Don’t use family controls.
...
- Chapter numbering: In a document with parts, chapter numbering continues
uninterrupted from part to part.
- Cross-references: In references to specific parts of a document, italicize the document
title but not the word Part, the part number, or the part title. Enclose the part title in
quotation marks.
...
passcode; password.
passphrase Avoid in user materials. Use passcode, password, or passkey, depending on
...
protected resource. Don’t use when you mean code, passcode, or passkey. See also code,
passcode; passkey.
...
- Home folder: In user materials, use your to indicate that the item being described is in
...
PDF Abbreviation for Portable Document Format. Not necessary to spell out on first
...
- Nonspecific quantities: When you describe a nonspecific quantity, use percentage, as in
...
printers, scanners, disk drives, modems, displays, and keyboards. OK to use peripheral
device, peripheral, or device. The adjective is singular: peripheral manufacturer, peripheral
connections.
...
Instant Hotspot refers to sharing a device’s Personal Hotspot with other devices where
the user is signed in to the same Apple Account. In general, use Instant Hotspot only as a
...
Incorrect: You can quickly connect to your Instant Hotspot without
entering a password.
petabyte See PB (n., adj.).
Phillips screw, Phillips screwdriver Note spelling. Not Phillips-head screw or Phillips-
head screwdriver.
phone numbers Use hyphens in U.S. phone numbers; don’t use parentheses or a leading
1. Use toll-free number, not 800 number. For numbers with extensions, use extension or
ext., not x. For phone numbers that use letters for easier recall, include the numeric form in
...
Correct: Select a color in the Colors window.
...
Incorrect: Select a color in the color picker.
...
place card In the Maps app, use to refer to an overlay that provides information about a
location. Don’t use information card.
...
Correct: Use QuickTime Player to view the movie.
Correct: Open the QuickTime Player app.
Incorrect: Open the QuickTime Player.
playhead One word.
...
Incorrect: For more information, please see “Store Settings” on
page 96.
...
- Acronyms and abbreviations: To form the plural of an acronym or an abbreviation, add
an s but no apostrophe.
CDs, DVDs
...
- Letters and symbols: To form the plural of a letter or symbol, add an apostrophe and an
s.
p’s, +’s
...
- Trademarked product names: Form the plural of trademarked product names by adding
...
When you subscribe to a podcast, you get new episodes as they’re released.
...
Preferable: Hold the pointer over an item to see a description of what
you can do with it.
...
dialog or window.
Correct: Tap Print.
Incorrect: Tap Print in the popover.
...
the device’s screen
the boss’s spouse
- Plural nouns: Form the possessive of a plural noun that ends in s by adding an
apostrophe. Form the possessive of a plural noun that doesn’t end in s by adding an
apostrophe and an s.
...
- Product names: Rewrite to avoid forming a possessive of any product name,
trademarked or not (for example, don’t use Keynote’s slides). See also trademarks
(usage).
...
power adapter Lowercase except in product names: plug in your power adapter; the 30W
USB-C Power Adapter. Avoid AC adapter.
...
power-up (n., adj.), power up (v.) Don’t use in user materials; use turn on or start up.
PRAM Acronym for parameter random-access memory. Pronounced “PEA-ram.” For
guidelines about spelling out acronyms, see abbreviations and acronyms.
...
However, always capitalize the name System Preferences.
Use the Trackpad pane of System Preferences to set the tracking
speed.
...
preinstalled, preloaded Avoid. Say installed, loaded, included, or other wording when
possible.
...
Correct: Press the Return key.
Correct: Press the power button.
Incorrect: Type your password and hit the Return key.
You can also use press to describe the act of pressing the stem on some models of
AirPods.
...
Correct: Force click an address to see it on a map.
Incorrect: Press an icon in the Dock until a menu appears.
...
- Don’t use press when you mean press and hold.
Correct: Press and hold the C key while you restart the computer.
...
- Don’t say press and drag; simply say drag.
See also click; enter; tap (n., v.); type (v.).

press and hold Use press and hold (not hold down) to describe the act of pressing the
...
Incorrect: To restart your Mac, press the power button.
...
Intelligence interactions that aren’t handled on device. It’s OK to abbreviate as PCC after
first reference.
...
Don’t use product in materials that discuss using and working with a specific device, such
as a Mac or Apple Watch. Instead, use the name of the device or an acceptable short
form—for example, computer instead of Mac, or watch instead of Apple Watch.
Acceptable: Slide the computer out of the rack.
Preferable: Slide the Mac Pro out of the rack.
Incorrect: Slide the product out of the rack.
See also device.
...
products:
AirPods, AirPods Max, AirPods Pro, AirTag, Apple Pencil, Apple TV 4K,
Apple TV HD, Apple Vision Pro, Apple Watch, Apple Watch Ultra,
HomePod, HomePod mini, iMac, iPad, iPad Air, iPad mini, iPad Pro,
iPhone, Mac, MacBook, MacBook Air, MacBook Pro, Mac mini,
Mac Pro, Mac Studio, Magic Keyboard, Magic Mouse, Magic Trackpad,
Pro Display XDR, Pro Stand, Studio Display
...
professional Don’t shorten to pro.
...
pronouns (he, his, him, she, her, hers) or combinations of gender-specific pronouns (he or
she, he/she, s/he). Instead, it’s OK to use they, their, or them as a singular, gender-neutral
pronoun.
...
When you use protocol as a generic term, use lowercase.
standard internet protocols
- Third-party products: When you refer to protocol names in third-party products,
...
See What is Motion? for more information. [The question mark is
italicized.]
Note the following:
...
- Parentheses, brackets, and quotation marks: Parentheses, brackets, and quotation
...
Read the manual (iPhone User Guide). [The parentheses aren’t
italicized.]
...
from a server and delivered to a device. Don’t use in user materials; use just notification.
Use lowercase for push notification except in proper names such as Apple Push
Notification service and Safari Push Notifications.
Developer materials: Your server generates push notifications, and
Apple Push Notification service (APNs) handles the delivery of those
notifications to devices.
User materials: You can allow websites to send you notifications.
pushpin One word.
...
QuickTime Player Don’t precede with the.
...
- Cross-references and quotations: Cross-references to sections and chapter titles
...
- Title-style onscreen elements: For title-style elements, use quotation marks only if
...
To change what appears in the login window, select an option next to
“Login window shows.”
See also checkbox.
...
been made. If payment has already been made, use receipt and not invoice. See also
invoice.
recommend When describing something users are encouraged to do, don’t use we
recommend or Apple recommends; use recommended.
...
(adj.).
Reduce Interruptions An Apple Intelligence feature. You can use the Reduce Interruptions
Focus or simply Reduce Interruptions.
...
Correct: The next major release of macOS will be available later this
year.
...
RFI Abbreviation for radio-frequency interference. Note hyphenation of the spelled-out
...
mouse button. For Mac, use Control-click instead.
...
rule of thumb Avoid; use general rule, general recommendation, guideline, or as a rule.
...
Correct: A consistency check can help confirm that software is
behaving as expected.
Incorrect: A sanity check can help confirm that software is behaving as
expected.
sans serif (adj.) Two words.
save You save a file on a disk or to a disk, not onto a disk.
scalable, scalability Not scaleable, scaleability.
...
Correct: Use screen sharing to show others what’s on your screen.
Incorrect: Use screen sharing to show others what’s on your display.
Correct: Position the display to minimize reflections and glare on your
screen.
...
about spelling out abbreviations, see abbreviations and acronyms.
SDH Short for subtitles for the deaf and hard of hearing. Define on first mention.
...
component.
See also HDR (n., adj.).
SDRAM Abbreviation for synchronous dynamic random-access memory. For guidelines
about spelling out abbreviations, see abbreviations and acronyms.
...
Preferable: coming later this year, starting early next year
Avoid: coming this fall, starting this spring
...
select (v.) Use select, not choose, to refer to the action users perform when they select
...
select (adj.) OK to use select to mean special or exclusive.
...
self Use a hyphen in terms beginning with self.
...
output.
However, always capitalize the name System Settings.
...
sexism, sexist language See Intro to inclusive writing.
...
Correct: Watch together using SharePlay on Apple TV 4K.
Incorrect: SharePlay a movie on Apple TV 4K.
Use join instead of access.
Correct: To join SharePlay on Apple TV 4K, tap the Play button.
Incorrect: To access SharePlay on Apple TV 4K, tap the Play button.
In user materials, avoid using session. (It’s OK to use session in developer materials.)
Avoid: Tap the Play button to start the SharePlay session.
Preferable: Tap the Play button to start the video.
...
share, send In user materials, use share to refer to giving ongoing access to a resource
or making it available to someone else—for example, sharing a Pages document, an App
Store purchase, your location, or your internet connection. Use send to refer to a one-time
action that transmits a static copy of something—for example, sending a file using Mail or
Messages.
Correct: Share your document with colleagues so you can make edits
together in real time.
Incorrect: Send your document to colleagues so you can make edits
together in real time.
Correct: Use AirDrop to send a document to someone nearby.
Incorrect: Use AirDrop to share a document with someone nearby.
It’s OK to use share to refer broadly to distributing items to others.
You can share your photos with friends using Mail, Messages, AirDrop,
and more.
In developer materials, you can use share sheet to refer to a sheet that presents tasks that
...
Correct: Tap , and then tap Messages.
Incorrect: Tap , and then tap Messages in the share sheet.
...
sheet In developer materials, use to refer to a view that lets people perform a task related
to their current context—such as supplying information or completing an action—before
returning to the previous view.
Don’t use sheet in user materials; in content about Mac, you can call a sheet a dialog.
Use the Print dialog to choose a printer and select print options.
In content about other platforms, in most cases, you can simply describe what the person
must select or do.
Correct: Tap Customize, then turn on Bold Text.
Incorrect: Tap Customize, then turn on Bold Text in the sheet that
appears.
Correct: Scroll to the bottom, then tap Manage Shared Note.
Incorrect: Scroll to the bottom of the sheet, then tap Manage Shared
Note.
...
To turn off iPhone, press and hold the side button and either volume button.
...
display.
sighted To refer to a person with sight, you can say a person who is sighted, a sighted
person, a person with sight. See also blind, low vision; Writing about disability.
...
Users sign in to accounts and services; computers, devices, and apps do not. Use sign in
to, not sign into.
Correct: Sign in to your Apple Account to get access to Apple services.
Incorrect: Your Mac must be signed in to your Apple Account to get
access to Apple services.
Users sign out of accounts and services (not sign off, sign off of, or sign off from).
See also login (n., adj.), log in (v.).

Sign in with Apple Note capitalization. The feature that lets users sign in to apps and
websites securely using their Apple Account. The word in is lowercase in both the name of
...
single Hyphenate compound adjectives beginning with single.
...
Apple TV 4K offers single sign-on authentication for users of some
apps.
See also sign-in (n., adj.), sign in (v.).
...
Avoid: You can use Hey Siri to schedule a meeting.
Preferable: To use Siri without pressing the Home button, say “Hey Siri,”
and then make your request.

Siri Remote Use to refer to the remote control that’s compatible with Apple TV 4K and
Apple TV HD. In countries or regions where Siri isn’t available for use with Apple TV
devices, use Apple TV Remote instead.
Use the Touch surface on the Siri Remote to set up your Apple TV 4K.
...
Correct: Siri Shortcuts provide a quick way to get things done.
Incorrect: You can use Siri shortcuts to do everyday tasks.
...
Incorrect: You can view Siri suggestions on your watch face.
When referring generally to individual suggestions, use lowercase suggestion and omit Siri.
Correct: To use a suggestion, tap it on the Lock Screen.
Incorrect: To use a Siri Suggestion, tap it on the Lock Screen.
...
object).
size (adj.) Hyphenate compound words ending with size. Not sized.
letter-size, medium-size, pocket-size
slash Use slash to describe this character: /. See also backslash.
...
sleep apnea notifications Capitalize only when referring to an onscreen label. Otherwise,
use lowercase.
In the Health app, tap Set Up below Sleep Apnea Notifications.
The sleep apnea notifications feature isn’t available in all countries or
regions.
Learn how to view your sleep apnea notifications.
slide (v.) Avoid when describing how users operate a slider or switch. Use tap, click, or
drag instead.
Correct: To increase or decrease the effect, drag the slider.
Incorrect: To increase or decrease the effect, slide the slider.
Correct: Tap the switch to turn Airplane Mode on or off.
Incorrect: Slide the switch to turn Airplane Mode on or off.
It’s OK to use other meanings of slide, in other contexts.
To slide smoothly between notes (called portamento), tap Pitch.
...
Correct: To adjust the magnification, drag the Zoom Level slider.
...
Smart Reply An Apple Intelligence feature. You can use Smart Reply to refer to the feature
...
Smart Stack Precede with the or a, depending on the context.
Live Activities appear at the top of the Smart Stack.
You can add a Smart Stack to your Home Screen.
The plural is also OK: Smart Stacks can automatically rotate to the most relevant
information.
...
application (or app) software and system software. Use software alone if you don’t need to
refer to a specific type of software. Don’t use software program.
Apple periodically releases updates to your computer’s software.
See also app, application, program; system software.
software development kit See SDK.
software license agreement Not software licensing agreement.
...
only in email but also in instant messaging, social media, and other systems.
...
speed For the speed of optical drives, use a lowercase x—for example, 24x speed. Note
that there’s no space between the numeral and the x.
spell-check (v.) Also OK to use check the spelling of a document.
...
- Spotlight icon: In the menu bar in macOS
- search field: The area where you enter search terms
- Spotlight window: Shows search results in macOS
SSD Abbreviation for solid-state drive. Precede with an, not a. It’s OK to use SSD alone
or in terms such as SSD storage; don’t use SSD drive. For guidelines about spelling out
...
volume.
stereotypes See Intro to inclusive writing.
...
Correct: You can import photos from an external storage device.
Incorrect: You can import photos from an external disk.
...
Use AirPlay to stream content from iPhone to Apple TV 4K.
...
sub (prefix) Close up words beginning with sub.
...
directory. In user materials, use folder. See also folder.
...
support Avoid in user materials when you can use compatible, works with, or another
...
movies you watch.
It’s OK to use surround alone (deliver in both stereo and surround).
...
Swipe can take a direct object in cases where users must precisely move an item (such as
...
right corner.
See also switch (v.).
switch (v.) OK to use to mean change or substitute.
...
inspectors.
Don’t use switch on or off or toggle to mean turn on or off.
...
symbol When referring to onscreen items, don’t use symbol when you mean button or
icon. A symbol signifies an idea or concept, but it doesn’t do anything when clicked or
...
sync, synced, syncing Not synch, synched, or synching.
...
- Syncing devices: Use with (not from or to).
Correct: Sync iPhone with your Mac.
Incorrect: Sync iPhone to your Mac.
...
library to it.
See also iCloud.
Don’t use synchronize or synchronization as alternative terms for sync or as an explanation
of the term sync.
Correct: Make sure syncing is turned on for the device.
Incorrect: Make sure synchronization is turned on for the device.
Although sync is most often used as a verb, it can also be used as a noun or an adjective.
You can also start a sync manually.
Avoid changing sync settings while iPhone is syncing.

system Don’t use system to refer to a computer by itself.
...
information.
System folder Note lowercase f.
system on a chip (n.), system-on-chip (adj.) Note hyphenation of adjective. It’s OK to
abbreviate as SoC; precede with an, not a. The plural form of the noun is systems on a chip
(SoCs).
...
TB (n., adj.) Abbreviation for terabyte. TB equals 10004 bytes in the context of file size or
storage capacity, and 10244 bytes in the context of computer memory. For guidelines about
spelling out abbreviations, see abbreviations and acronyms.
- Noun: In the noun form, use a space between the numeral and the abbreviation. The
preposition of is necessary before the unit that the value quantifies.
1 TB of memory
...
abbreviations, see abbreviations and acronyms.
TCP/IP Abbreviation for Transmission Control Protocol/Internet Protocol. For guidelines
about spelling out abbreviations, see abbreviations and acronyms.
telephone number In most cases, use phone number (not telephone number). See also
phone numbers.
television TV is preferred. Don’t use television set or TV set. See also Apple TV 4K.
...
as nouns.
Correct: Click Reply in a notification to reply to an email or text
message.
Correct: To delete all messages in the thread, tap Delete All.
Incorrect: To delete all texts in the thread, tap Delete All.
...
third party (n.), third-party (adj.) The adjective is hyphenated. Don’t use 3rd-party, 3P,
or other shortened forms.
You can use certain third-party products with the Find My app.
If your audience may not be familiar with the term, you can use not made by Apple, from
other companies, or similar wording.
thread In the context of a series of related files, such as email messages, items are in a
thread.
You can reply to an earlier message in the thread.
three-dimensional See 3D.
three-prong outlet Don’t use. Use grounded outlet.
throw away Don’t use when you mean drag an item to the Trash.
Correct: After you’ve expanded the compressed file, drag it to the
Trash.
Incorrect: Throw away the compressed file after you expand it.
thumb Don’t use when you mean scroller or slider.
tilde (~) See pathnames.
timecode One word.
timeline One word.
...
time zone In general, you can refer to time zones using the shortened form (or two-letter
abbreviation). Use lowercase for shortened forms: Pacific time (PT), mountain time (MT),
central time (CT), eastern time (ET). The time zone is usually abbreviated when it follows
the time.
The event begins at 10:00 a.m. PT.
You can view your events in eastern time even if you’re in the Pacific
time zone.
If you need to be more specific, you can use the full name (or three-letter abbreviation).
Use lowercase for the full names (exception to The Chicago Manual of Style): Pacific
standard time (PST), mountain daylight time (MDT), central daylight time (CDT), eastern
standard time (EST).
Requests must be submitted by 11:59 p.m. PDT.
Event times are shown in eastern standard time.
...
Today View Don’t precede with the.
Drag the widget to a new location in Today View.
to-do (adj.) Note hyphen: to-do list. Don’t use as a noun.
...
pressing it more than once.
touch In visionOS, it’s OK to use touch when referring to interacting directly with virtual
...
Touch surface The touch-sensitive upper half of the Siri Remote. You press the Touch
surface, rather than tap or click.
...
Transparency An AirPods listening mode. OK to use Transparency or Transparency mode.
Trash Use an article (drag the file to the Trash).
...
Don’t use to refer to quickly pressing a mechanical button three times; use triple-click.
...
TV Not TV set or television set. See also Apple TV 4K.
tvOS Apple’s operating system for Apple TV devices. Use without an article.
...
interface.
UK No periods. OK to abbreviate or to spell out United Kingdom as a noun. Use the
abbreviation for the adjective form.
...
The Copy command is unavailable if there’s no text selected.
See also dimmed.
uncheck Don’t use; use deselect. See also checkbox.
...
Correct: Use the commands in the Arrange menu.
Incorrect: Use the commands under the Arrange menu.
Don’t use to describe where things are in the interface; use below instead.
Correct: The mailboxes below On My Mac are stored on your computer.
Incorrect: The mailboxes under On My Mac are stored on your computer.
...
uninstall OK to use uninstall and uninstaller. See also install.
unit Don’t use to refer to a hardware product. Use a different noun as appropriate.
Correct: Take apart the computer.
Incorrect: Take apart the unit.
...
Avoid: Unmount the disc when you finish using it.
Preferable: Eject the disc when you finish using it.
...
Don’t use unmount as an intransitive verb.
Correct: Unmount the volume.
Incorrect: The volume unmounts.
See also mount (v.); mounted (adj.).
unmounted (adj.) In user materials, avoid when referring to a disk or disk image that isn’t
available; use alternatives such as not available or not visible in a Finder window.
Avoid: If a disk is unmounted, you can’t access files on it until you
mount it again.
Preferable: If a disk is unavailable, you can’t access files on it until you
...
macOS Tahoe 26.1 is an update to macOS Tahoe 26.
Don’t use maintenance release or dot release. See also upgrade; version number.
upgradable Not upgradeable.
upgrade Use to refer to a major version of a software product. For example, macOS Tahoe
is an upgrade to macOS Sequoia. See also update; version number.
...
Avoid: Every new photo you take is uploaded to My Photo Stream.
Preferable: Every new photo you take appears in My Photo Stream.
See also iCloud.
...
Incorrect: The volumeName may have up to 12 characters.
Incorrect: The volumeName may have up to 12 characters.
See also placeholder names; Intro to technical notation.
...
example, Keynote 15.2, not Keynote version 15.2.
Compressor 5 includes support for Apple Immersive Video packaging.
Final Cut Pro is the software of choice for professional video editors.
When referring to a major release number (such as macOS 15 or iOS 18), omit any trailing
.0 unless it’s needed for clarity.
Find out what changed between Numbers 14.0 and Numbers 14.1.
- Earlier or later: Use earlier or later, rather than lower or higher or newer or older.
To unsend or edit text messages, you need to use iMessage in iOS 16 or later.
- Multiple operating systems: When listing multiple operating systems that have the
same version number, include the version number after each OS name. Don’t place the
version number only at the end of the list.
Correct: You need iOS 26, iPadOS 26, macOS 26, visionOS 26, or later.
Incorrect: You need iOS, iPadOS, macOS, or visionOS 26 or later.
To avoid repetition, you can lead with the version number: You need version 26 or later
of iOS, iPadOS, macOS, or visionOS.
- The letter x: Except in developer materials, don’t use x to mean “any number,” as in 15.x;
...
video Note the treatment of these terms beginning with video:
...
video signal.
In general references, it’s OK to use just camera.
...
- For special audiences, such as administrators, use volume if a precise distinction
...
guidelines about spelling out acronyms, see abbreviations and acronyms.
want Make sure that an object follows the verb want.
Correct: Make a copy if you want a duplicate. [The word duplicate is the
object.]
Correct: Sign up if you want to attend. [The infinitive, to attend, is the
object.]
...
watchlist One word (exception to Merriam-Webster).
You can add movies and TV shows to your watchlist.
...
website can contain many webpages. You connect to (or go to) a page; you’re then at that
page. Text, graphics, and links, however, are on the page.
...
well-behaved Don’t use to describe software; use compatible, well-constructed, and
the like.
wellbeing One word (exception to Merriam-Webster).
wheelchair user OK to use to describe a person in a wheelchair; also OK to say a person in
a wheelchair or a person who uses a wheelchair. Don’t use wheelchair-bound, confined to
a wheelchair, or handicapped. See also Writing about disability.
...
frame plays back, with no frames dropped.
Correct: SD video uses interlaced scanning, whereas HD formats may
use either interlaced or progressive scanning.
Incorrect: SD video uses interlaced scanning, while HD formats may use
...
wide Use a hyphen in compound adjectives beginning with wide.
...
Except for the Picture in Picture window, don’t use window to refer to interface elements
in iOS. Instead of naming an element, in most cases you can simply describe what the user
must select or do. If necessary, you can usually use alternative words such as list.
...
wireless-enabled Not wirelessly-enabled.
wish Don’t use; use want. See also want.
...
work Close up the following words beginning with work:
workflow, workforce, workgroup, workplace, workshop, workspace,
workstation
workflow One word.
workspace Don’t use as a synonym for desktop or Finder.
workstation (n., adj.) Don’t use when you mean desktop computer. OK to use when you
...
See also burn.
Writing Tools An Apple Intelligence feature. Use a plural verb with Writing Tools.
...
- As a placeholder (variable): When you use x as a placeholder for replaceable numbers,
the x is lowercase and in regular text.
...
x and y axes No hyphen. See also x-axis; y-axis.
...
only from Western culture.
- Avoid using examples that reflect primarily an affluent lifestyle.
A stereotype is a fixed belief about people or groups based on identifying characteristics,
...
| Disabled people   | People with disabilities   | Special needs     |
Special abilities
Handicapped
Handicapable
...
| A deaf person                         | A person who is deaf            | Hearing impaired |
| ------------------------------------- | ------------------------------- | ---------------- |
| Note: Use Deaf (with a capital D) to  | A person who is hard of hearing | Deaf and dumb    |
refer to those who identify culturally
|     | People who are deaf or hard of  | Deaf-mute |
| --- | ------------------------------- | --------- |
as Deaf—for example, a member of
hearing
the Deaf community.
| A deafblind person | A person who is deaf and blind |     |
| ------------------ | ------------------------------ | --- |
Note: Some communities capitalize
the D, or both the D and B—for
example, a DeafBlind person, the
DeafBlind community. If you’re
writing about someone specific, ask
them what they prefer.
| A limb-different person | A person with limb differences |                          |
| ----------------------- | ------------------------------ | ------------------------ |
| An amputee              | A person who had an amputation |                          |
| A wheelchair user       | A person who uses a wheelchair | Wheelchair-bound         |
|                         | A person in a wheelchair       | Confined to a wheelchair |

| Identity first | Person first | Avoid |
| -------------- | ------------ | ----- |
An autistic person A person on the autism spectrum A person with autism, people with
autism
| Autistic people | People on the spectrum |     |
| --------------- | ---------------------- | --- |
...
| culturally as autistic capitalize the  | identity-first language to person- |     |
| -------------------------------------- | ---------------------------------- | --- |
A—for example, an Autistic person.  otherwise, use on the spectrum)
first language. However, if you’re
If you’re writing about someone  writing about someone specific, ask  High-functioning, low-functioning
specific, ask them how they prefer  them what they prefer. (instead, describe the type of
...
are neurodivergent or neurotypical;
a group is neurodiverse)
| A nonspeaking person | A person who is nonspeaking | Mute |
| -------------------- | --------------------------- | ---- |
| A nonverbal person   | A person who is nonverbal   |      |
Note: The terms above have distinct
...
- Plurals: Unit symbols and abbreviations are unaltered in the plural forms (for example,
lb., not lbs.).
...
| ------------------------ | ---- | ----------------------- |
| amperes per square meter | A/m2 | current density         |
...
gigabits per second Gbit/s (standard) speed of data transmission
...
| gram                       | g     | mass, weight               |
| grams per cubic centimeter | g/cm3 | density                    |
| henry                      | H     | inductance                 |
...
kilobits per second kbit/s (standard) speed of data transmission
...
megabits per second Mbit/s (standard) speed of data transmission
...
| micrometer (10–6 meters) | µm [Option-M] | length                     |
...
| minute                          | min.                        | time                 |
| month                           | mo.                         | time                 |
| newton (kilogram-meters per     | N                           | force                |
second squared)
newtons per square meter. See
pascal.
...
| radians per second squared        | rad/s2                   | angular acceleration |
| revolutions per minute            | rpm                      | angular velocity     |
| second                            | s (unit symbol) or sec.  | time                 |
(abbreviation)
...
terabits per second Tbit/s (standard) speed of data transmission
...
| volts (point-to-point) | V   | electric potential |
| ---------------------- | --- | ------------------ |
pp
| volts (root mean square) | V   | electric potential |
| ------------------------ | --- | ------------------ |
rms
...
https://www.iso.org
- Standard: ISO 3166
- Usage: Countries are represented by a two-character code in a table, column, or row
...
https://www.iso.org
- Standard: ISO 4217
- Rationale: Currency codes are specific to a currency and can’t be confused or
...
https://www.iso.org
- Standard: ISO 639
- Usage: Languages are represented by a two-character code in a table, column, or row
...
- International authority: International Telecommunication Union (ITU),
https://www.itu.int
...
- International authority: Bureau International des Poids et Mesures (BIPM),
https://www.bipm.org
- Standard: BIPM SI Brochure. United States interpretation is available from the
...
(Option-Space bar) between the quantity and its symbol. Unit symbols are unaltered in
the plural and are never hyphenated, even when they’re used as an adjective. Symbols
for SI units of measure aren’t followed by a period unless they appear at the end of a
sentence. Don’t imply more precision than is reasonable in choosing a unit symbol.
The Apple USB-C to 3.5 mm Audio Cable is 1.2 m long.
MacBook Neo weighs 1.23 kg.
Equivalent values in non-SI units may be given in parentheses following SI values.
iPad mini (A17 Pro) Wi-Fi models weigh 293 g (0.65 lb.).
